    ...
    <div class="page-table">
      ...
      >
        ...
        <template v-if="type === 2">
          <el-table-column prop="proviceName" label="分数"></el-table-column>
          <el-table-column
            prop="proviceName"
            label="视频名称"
          ></el-table-column>
        ...
        <template v-else>
          <el-table-column prop="" label="论文"></el-table-column>
          <el-table-column prop="" label="查重文件"></el-table-column>
          <el-table-column prop="" label="分数"></el-table-column>
        </template>
